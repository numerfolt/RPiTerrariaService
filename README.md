...
## Setup
Make sure that you have downloaded the dedicated terraria server from https://terraria.wiki.gg/wiki/Server and followed the ["How to (RPI / Others OSes)"](https://terraria.wiki.gg/wiki/Server#How_to_(RPI_/_Others_OSes)) before using the TerrariaService.
